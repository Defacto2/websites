	...
	<table cellpadding="0" cellspacing="0" class="box01">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="box02">
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:500px; margin-left:auto; margin-right:auto; margin-top:10px;"><tr><td>
				<span style="float:left;"><a href="feed2.cfm?format=atom1&amp;list=tsn" title="The Scene News &amp; Defacto2 Atom feed"><img src="images/xml.gif" alt="Atom Feed" class="feedIcon" /></a></span>
				<span style="float:left;"><a href="feed2.cfm?format=rss2&amp;list=tsn" title="The Scene News &amp; Defacto2 RSS feed"><img src="images/rss.gif" alt="RSS Feed" class="feedIcon" /></a></span>
				<span style="float:left; margin-left:40px;">The Scene News with Defacto2 news</span>
			</td></tr><tr><td>
				<span style="float:left;"><a href="feed2.cfm?format=atom1&amp;list=scenenews" title="The Scene News Atom feed"><img src="images/xml.gif" alt="Atom Feed" class="feedIcon" /></a></span>
				<span style="float:left;"><a href="feed2.cfm?format=rss2&amp;list=scenenews" title="The Scene News RSS feed"><img src="images/rss.gif" alt="RSS Feed" class="feedIcon" /></a></span>
				<span style="float:left; margin-left:40px;">The Scene News</span>
			</td></tr><tr><td>
				<span style="float:left;"><a href="feed2.cfm?format=atom1&amp;list=sitenews" title="Defacto2 web site news and updates Atom feed"><img src="images/xml.gif" alt="Atom Feed" class="feedIcon" /></a></span>
				<span style="float:left;"><a href="feed2.cfm?format=rss2&amp;list=sitenews" title="Defacto2 web site news and updates RSS feed"><img src="images/rss.gif" alt="RSS Feed" class="feedIcon" /></a></span>
				<span style="float:left; margin-left:40px;">Defacto2 news</span>
			</td></tr><tr><td>
				<div style="margin-top:8px;"></div>
				<span style="float:left;"><a href="feed2.cfm?format=atom1&amp;list=newfiles" title="New files added to the website Atom feed"><img src="images/xml.gif" alt="Atom Feed" class="feedIcon" /></a></span>
				<span style="float:left;"><a href="feed2.cfm?format=rss2&amp;list=newfiles" title="New files added to the website  RSS feed"><img src="images/rss.gif" alt="RSS Feed" class="feedIcon" /></a></span>
				<span style="float:left; margin-left:40px;">New files</span>
			</td></tr><tr><td>
				<span style="float:left;"><a href="feed2.cfm?format=atom1&amp;list=filepacks" title="File pack updates Atom feed"><img src="images/xml.gif" alt="Atom Feed" class="feedIcon" /></a></span>
				<span style="float:left;"><a href="feed2.cfm?format=rss2&amp;list=filepacks" title="File pack updates RSS feed"><img src="images/rss.gif" alt="RSS Feed" class="feedIcon" /></a></span>
				<span style="float:left; margin-left:40px;">File pack updates</span>
			</td></tr><tr><td>
				<span style="float:left;"><a href="feed2.cfm?format=atom1&amp;list=cracktros" title="Scene Archive cracktro updates Atom feed"><img src="images/xml.gif" alt="Atom Feed" class="feedIcon" /></a></span>
				<span style="float:left;"><a href="feed2.cfm?format=rss2&amp;list=cracktros" title="Scene Archive cracktro updates RSS feed"><img src="images/rss.gif" alt="RSS Feed" class="feedIcon" /></a></span>
			...
			<div class="feedValidate">
				<a href="http://feedvalidator.org/check.cgi?url=http://www.defacto2.net/feed2.cfm?format=rss2&amp;list=scenenews" title="Validate a Defacto2 RSS feed"><img src="images\valid-rss.png" alt="[Valid RSS]" style="border:0px; width:88px; height:31px;" /></a>
				&nbsp; &nbsp;
				<a href="http://feedvalidator.org/check.cgi?url=http://www.defacto2.net/feed2.cfm?format=atom1&amp;list=scenenews" title="Validate a Defacto2 Atom 1.0 feed"><img src="images\valid-atom.png" alt="[Valid Atom 1.0]"  style="border:0px; width:88px; height:31px;" /></a>
			</div>
...
<cfquery name="getSiteNews" datasource="#application.newsSource#">
	SELECT * FROM thescenenews WHERE Hide <> 1 AND Defacto2News = 1 ORDER BY id desc
</cfquery>

<!--- Map the feed attributes to the query columns. --->
<cfset columnMapStruct = StructNew()>
<cfset columnMapStruct.title = "title">
<cfset columnMapStruct.pubDate = "OBCTime">
<cfset columnMapStruct.content = "description">
<cfset columnMapStruct.source = "source">
<cfset columnMapStruct.sourceurl = "sourcelink">

<!--- <cfset columnMapStruct.id = "orderid">
<cfset columnMapStruct.categorylabel = "state">
<cfset columnMapStruct.dc_title = "title">
<cfset columnMapStruct.dc_publisher = "title">
<cfset columnMapStruct.dc_description = "content">
<cfset columnMapStruct.dc_date = "orderdate"> --->
<!--- Create the feed metadata. --->
<cfscript>
	meta.title = "Defacto2 - Site Related News";
	meta.description = "All the latest updates on Defacto2";
	meta.link = "http://www.defacto2.net";
	meta.category.value = "Defacto2 News";
	meta.version = "rss_2.0";
	meta.image = "http://www.defacto2.net/images/btn-df2.gif";
	meta.rights = "1996-#LSDateFormat(Now(),'YYYY')# Defacto2";
</cfscript>
<!--- Generate the feed --->
<cf_feed query="#getSiteNews#" properties="#meta#" columnMap="#columnMapStruct#" xmlvar="xmloutput">
